-- ==========================================================
-- SCRIPT DE CRÉATION ET DE PEUPLEMENT - VERSION SQL 8.0+
-- Correction Warning #1287 : Remplacement de VALUES() par alias
-- ==========================================================
...
(1, 'Stark Biotech (Labo Expérimental)', '0491010101', 'research@stark-bio.tech', 'Petit laboratoire de recherche.', 245000, 4, 101),
(2, 'Knowhere Mining Corp.', '0140020202', 'collector@knowhere.space', 'Opération d''extraction de fluide spinal.', 205000, 3, 102),
(3, 'Asgardian Forges', '0607030303', 'smith@nidavellir.realms', 'Atelier de forge légendaire.', 180000, 2, 103),
(4, 'Wakanda Logistics', '0388040404', 'shuri@wakanda.gov', 'Transport rapide via Maglev Vibranium.', 230000, 5, 104),
(5, 'Xandar Garden Care', '0561050505', 'nova@xandar.corps', 'Entretien des espaces verts.', 195000, 2, 105),
(6, 'Sakaar Scrappers', '0478060606', 'grandmaster@sakaar.arena', 'Récupération de déchets spatiaux.', 215000, 3, 106),
(7, 'Madripoor Imports', '0383070707', 'broker@madripoor.low', 'Échange de marchandises rares.', 250000, 5, 107),
(8, 'Titan Salvage', '0556080808', 'survivor@titan.ruins', 'Récupération de technologies.', 175000, 2, 108),
(9, 'Hala Tech Research', '0240090909', 'science@kree.empire', 'Recherche Kree.', 220000, 3, 109),
(10, 'Kyln Security Solutions', '0320101010', 'warden@kyln.prison', 'Systèmes de verrouillage de prison.', 190000, 5, 110)
AS c
ON DUPLICATE KEY UPDATE 
...
(11, 'Pym Technologies', '0491111111', 'hank@pym.tech', 'Start-up particules subatomiques.', '2025-11-15', 1, 201),
(12, 'Sovereign Batteries', '0140121212', 'ayesha@sovereign.gold', 'Transporteur d''énergie Anulax.', '2025-10-01', 1, 202),
(13, 'Vormir Soul Seekers', '0607131313', 'keeper@vormir.stone', 'Groupe de pèlerins.', '2025-09-20', NULL, 203),
(14, 'Ego Terraforming', '0388141414', 'peter@ego.dad', 'Opérateur d''expansion planétaire.', '2025-11-10', 0, 204),
(15, 'Kamar-Taj Wifi', '0561151515', 'wong@sanctum.magic', 'Réseau pour sorciers.', '2025-11-18', 1, 205),
...
(18, 'Quantum Realm Explorers', '0556181818', 'scott@quantum.micro', 'Voyage microscopique.', '2025-11-05', 1, 208),
(19, 'Latveria School of Bots', '0240191919', 'doom@latveria.gov', 'Formation robotique.', '2025-09-10', NULL, 209),
(20, 'Ten Rings Dojo', '0320202020', 'wenwu@tenrings.org', 'Organisation arts martiaux.', '2025-11-20', 1, 210)
AS p
ON DUPLICATE KEY UPDATE 
